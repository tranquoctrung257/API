...
def YOUTUBE():
    ...
    if choose >=1 or choose <= len(user_YTB) :
        ...
        os.system('cls' if os.name== 'nt' else 'clear')
        print(rainbow_text('1:Sử Dụng Dữ Liệu Tài Khoản Cũ!'))
        print(rainbow_text('2:Xóa Dữ Liệu Tài Khoản Cũ!'))
        ...
        DELAY = int(input(rainbow_text("Nhập Deplay: ")))
        while True:
